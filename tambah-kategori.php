...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <div>
            <form class="form-container" action="tambah-kategori-proses.php" id="formBarang" method="POST">
            <input type="hidden" name="id_kategori" value="<?= $b['id'] ?>">
            <div class="mb-3">
                <label  class="form-label">Nama Kategori: </label>
                <input type="text" class="form-control" name="nama_kategori" id="nama_kategori">
            </div>
            <button type="submit" name="simpan" class="btn btn-success w-100">Simpan Kategori</button>
            </form>
        </div>
