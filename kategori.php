<?php
    ...
    $totalDataQuery = "SELECT COUNT(*) AS total FROM kategori $whereSQL";
    ...
    $sql = "SELECT * FROM kategori ORDER BY nama_kategori ASC LIMIT $limit OFFSET $offset";
    ...
    <div class="main-container">
        ...
        <form action="" class="row mb-3" id="filterForm">
            ...
            <div class="col-md-4 text-align-end">
                <a href="tambah-kategori.php" class="btn btn-success btn-add">Tambah Kategori</a>
            </div>
        </form>
            ...
            <table class="table table-hover table-striped mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-kategori.php?&id=<?= $k['id'] ?>" class="btn btn-success btn-sm">Edit</a> 
                            <a href="#" class="btn btn-danger btn-sm" onclick="ConfirmDelete('hapus-kategori.php?id=<?= $k['id']; ?>')"><i class="fas fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        <div class="popup" id="popupDelete">
            <div class="popup-content-delete">
                ...
                <p>Apa Anda Yakin Ingin Menghapus Kategori Ini?</p>
