<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $sql = "INSERT INTO barang (nama_barang, kategori_id, stok, harga, tanggal_masuk)
                VALUES ('$nama_barang','$kategori','$stok','$harga_barang','$tanggal_masuk')";
...
<body>
    <div class="popup-overlay">
        <div class="popup-box">
            ...
            <?php } else { ?>
            <div class="gagal">
                <h3>Terjadi Kesalahan Saat Menambahkan Data!</h3>
