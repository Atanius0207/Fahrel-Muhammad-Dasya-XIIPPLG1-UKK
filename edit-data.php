...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <div>
            <form class="form-container" action="edit-data-proses.php" id="formBarang" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="kategori" id="kategori" class="form-control">
                    ...
                    <?php
                        ...
                        $selected = ($k['id'] == $b['kategori_id']) ? 'selected' : '';
                    ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="stok" id="stok" value=<?= $b['stok'] ?>>
            </div>
            <div class="mb-3">
                <label  class="form-label">Harga Barang:</label>
                <input type="text" class="form-control" name="harga_barang" id="harga_barang" value=<?= $b['harga'] ?>>
            </div>
            <div class="mb-3">
                <label  class="form-label">Tanggal Masuk</label>
                <input type="date" class="form-control" name="tgl_msk" id="tgl_msk" value=<?= $b['tanggal_masuk'] ?>>
            </div>
